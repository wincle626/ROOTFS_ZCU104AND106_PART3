...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/aarch64-linux-gnu/ruby/2.7.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr' '--enable-multiarch' '--target=aarch64-linux-gnu' '--program-suffix=2.7' '--with-soname=ruby-2.7' '--enable-shared' '--disable-rpath' '--with-sitedir=/usr/local/lib/site_ruby' '--with-sitearchdir=/usr/local/lib/aarch64-linux-gnu/site_ruby' '--runstatedir=/var/run' '--localstatedir=/var' '--sysconfdir=/etc' '--enable-ipv6' '--with-dbm-type=gdbm_compat' '--with-compress-debug-sections=no' 'CFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong -Wformat -Werror=format-security' 'CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2' 'CXXFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong -Wformat -Werror=format-security' 'FCFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong' 'FFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong' 'GCJFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong' 'LDFLAGS=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now' 'OBJCFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong -Wformat -Werror=format-security' 'OBJCXXFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong -Wformat -Werror=format-security' 'target_alias=aarch64-linux-gnu'"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong -Wformat -Werror=format-security"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  ...
  CONFIG["CFLAGS"] = "-g -O2 -fdebug-prefix-map=/build/ruby2.7-jjPnk9/ruby2.7-2.7.0=. -fstack-protector-strong -Wformat -Werror=format-security -fPIC"
  CONFIG["CC"] = "gcc"
